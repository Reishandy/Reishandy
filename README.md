### About Me:
Full-stack developer specializing in secure, scalable web and mobile solutions. I architect robust systems using modern stacks like **FastAPI + Android Jetpack Compose + MongoDB + SwiftUI** with a focus on:
- Building security-first applications
- Delivering optimized solutions
- Linux enthusiast (I use Arch btw)
- Running managed home lab server with Cloudflare, Docker, Nginx running on Arch (again)
